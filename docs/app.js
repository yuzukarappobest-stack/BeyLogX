...
const CATALOG = {
  ...
  standardBlades: [
    ...
    "バレットグリフォン", "グローリーワルキューレ", "ラスタードラグーン",
  ...
  overBlades: ["B（ブレイク）", "G（ガード）", "F（フロー）", "P（ピーク）", "O（アウター）", "T（タフ）"],
  metalBlades: ["ブリッツ", "フォートレス", "レイジ", "デルタ", "ウイップ", "トレッド"],
  assistBlades: [
  ...
  ratchets: [
    ...
    "4-50", "4-60", "4-70", "4-80", "5-50", "5-60", "5-70", "5-80",
  ...
  bits: [
    ...
    "A（アクセル）", "Q（クエイク）", "C（サイクロン）", "LC（ローサイクロン）", "L（レベル）",
